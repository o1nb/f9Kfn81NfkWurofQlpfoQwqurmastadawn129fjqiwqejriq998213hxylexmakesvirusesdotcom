...
local getcustomassets = {
	['newprism/assets/rise/slice.png'] = 'rbxasset://risesix/slice.png',
	['newprism/assets/rise/blur.png'] = 'rbxasset://risesix/blur.png',
...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('newprism/assets/new/blur.png')
...
local function writeFont()
	...
	writefile('newprism/assets/rise/risefont.json', httpService:JSONEncode({
		name = 'ProductSans',
		faces = {
			{style = 'normal', assetId = getcustomasset('newprism/assets/rise/SF-Pro-Rounded-Light.otf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('newprism/assets/rise/SF-Pro-Rounded-Regular.otf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('newprism/assets/rise/SF-Pro-Rounded-Medium.otf'), name = 'Medium', weight = 500},
			{style = 'normal', assetId = getcustomasset('newprism/assets/rise/Icon-1.ttf'), name = 'Icon1', weight = 600},
			{style = 'normal', assetId = getcustomasset('newprism/assets/rise/Icon-3.ttf'), name = 'Icon3', weight = 800}
		}
	}))
	return getcustomasset('newprism/assets/rise/risefont.json')
end

if inputService.TouchEnabled then
	writefile('newprism/profiles/gui.txt', 'new')
	return
end
		...
		for i, v in mainapi.Modules do
			if v.Enabled or table.find(found, i) then
				...
				if interfacebar.Enabled then
					...
					holderline.Image = getcustomasset('newprism/assets/rise/slice.png')
