...
local getcustomassets = {
	['newprism/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/o1nb/f9Kfn81NfkWurofQlpfoQwqurmastadawn129fjqiwqejriq998213hxylexmakesvirusesdotcom/'..readfile('newprism/profiles/commit.txt')..'/'..select(1, path:gsub('newprism/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('newprism/assets/wurst/triangle.png')
